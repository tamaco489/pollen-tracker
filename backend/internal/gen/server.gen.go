...
func RegisterHandlersWithOptions(router EchoRouter, si ServerInterface, options RegisterHandlersOptions) {
	...
	router.GET(options.BaseURL+"/pollens", wrapper.GetPollen, options.OperationMiddlewares["GetPollen"]...)
	router.GET(options.BaseURL+"/stats", wrapper.GetStats, options.OperationMiddlewares["GetStats"]...)
...
type GetStats400JSONResponse BadRequestError
...
type GetStats500JSONResponse InternalServerError
...
func (sh *strictHandler) GetStats(ctx *echo.Context, params GetStatsParams) error {
